...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddProduct = channel.unary_unary(
                ...
                request_serializer=mensaje__pb2.Product.SerializeToString,
                response_deserializer=mensaje__pb2.TransactionResponse.FromString,
                )
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddProduct': grpc.unary_unary_rpc_method_handler(
                    servicer.AddProduct,
                    request_deserializer=mensaje__pb2.Product.FromString,
                    response_serializer=mensaje__pb2.TransactionResponse.SerializeToString,
            ),
    }
...
class ProductService(object):
    ...
    def AddProduct(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ProductService/AddProduct',
            mensaje__pb2.Product.SerializeToString,
            mensaje__pb2.TransactionResponse.FromString,
